 ...
 * Extrait les paramètres de connexion à la base de données
 * stockés dans le fichier passé en paramètre
 */
...
public final class CParametresStockageBDD {
    ...
    */
    ...
    /**
     *Affiche  les paramètres récupérés (pour test)
     * @return
     */
    @Override
    ...
    /**
     * Test de la lecture du fichier de parametrage de la connexion
    ...
    public static void main(String[] args) {
        ...
        if (parametresStockageBDD.isParametreBDDOK()) {
            System.out.println("Paramètres chargés : " + parametresStockageBDD.toString());
        } else {
